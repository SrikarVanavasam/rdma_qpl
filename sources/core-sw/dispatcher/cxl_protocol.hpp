...
constexpr int32_t QPL_COMBINED_CXL_NUMA_ID         = -108; // Round-robin: local + CXL proxy (busy-spin)
constexpr int32_t QPL_COMBINED_CXL_UMWAIT_NUMA_ID  = -109; // Round-robin: local + CXL proxy (umwait)
