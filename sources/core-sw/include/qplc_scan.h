 ...
 * @{
 */
OWN_QPLC_API(void, qplc_scan_eq_8u_i,
...
OWN_QPLC_API(void, qplc_scan_ne_8u_i,
             (uint8_t * src_dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value));
...
OWN_QPLC_API(void, qplc_scan_lt_8u_i,
...
OWN_QPLC_API(void, qplc_scan_le_8u_i,
             (uint8_t * src_dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value));
...
OWN_QPLC_API(void, qplc_scan_gt_8u_i,
             (uint8_t * src_dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value));
...
OWN_QPLC_API(void, qplc_scan_ge_8u_i,
             (uint8_t * src_dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value));
